                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3 mt-3 mt-sm-0">
                                                            ...
                                                            <select data-plugin="customselect" class="form-select"
                                                                ...
                                                                <option value="N_A">Please select one or start typing
                                                                </option>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="action_btns">
                                                    ...
                                                    <button type="button" onclick="validateForm(this,'myForm')" class="theme_btn btn-primary btn"><i class="bi-arrow-up-right"></i> Save and Send</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
