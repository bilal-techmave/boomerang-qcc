   ...
   <div class="create_template_header">
      <div class="htem_text_back">
         ...
         <div class="right_publishection">
            ...
            <a href="#"><button type="button" class="publishtemp_bnt" id="submitButton"><i class="fa-regular fa-paper-plane"></i> Publish</button></a>
   ...
   <div class="createtemp_formarea">
      <div class="container">
         <div class="formedit_createarea">
            <form id="myForm" action="{{route('template.update', encrypt($template->id))}}" method="post">@csrf
                                 ...
                                 <div class="image-upload-container">
                                    <div class="profile-pic-wrapper">
                                       <div class="pic-holder">
                                          ...
                                          <input class="uploadProfileInput" type="file" id="newProfilePhoto" accept="image/*" style="opacity: 0;" />
                                          <input type="hidden"  id="t_picture" name="t_picture" >
...
<script>
    $(document).ready(function() {
        $('#newProfilePhoto').on('change', function() {
            ...
            $('#t_picture').trigger('change', formData); // Trigger change event with FormData object
        });
    });
</script>
<script>
      ...
      $.ajax({
         ...
         success: function(response) {
            if (response.success == true) {
               $(".sortable-list").empty();
               $(".sortable-list").append(response.data);
