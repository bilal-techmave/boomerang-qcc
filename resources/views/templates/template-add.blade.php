   ...
   <div class="create_template_header">
      <div class="htem_text_back">
         ...
         <div class="right_publishection">
            ...
            <a href="#"><button type="button" id="submitButton" class="publishtemp_bnt"><i class="fa-regular fa-paper-plane"></i> Publish</button></a>
   ...
   <div class="createtemp_formarea">
      <div class="container">
         <div class="formedit_createarea">
            <form id="myForm" action="{{route('template.store')}}" method="post">@csrf
                           ...
                           <div class="form-builder">
                              <div class="templateheader_title">
                                 ...
                                 <div class="templateinput_title_description">
                                    <input type="text" id="pageTitle" name="t_name" placeholder="Untitled Template">
                                    <input type="text" id="pageDescription" name="t_description" placeholder="Add a description">
                                 </div>
                              </div>
                                          ...
                                          <ul class="sortable-list_{{$i}}" id="accordion">
                                             <li class="sortable-item">
                                                <div class="sortebla_item_edit">
                                                   ...
                                                   <input type="text" name="question[0][value]" class="question-input" placeholder="Type Question">
                                                   <div class="col-lg-4">
                                                      <div class="answerboxwth_dropdown">

                                                         <div type="button" id="text_1" class="answer-button accordion-button" onclick="toggleAccordion(this, 'Modal 1');">
                                                      ...
                                                      <div class="leftfield_setting_container">
                                                         ...
                                                         <div class="required_firlscheck">
                                                            <div class="form-check">
                                                               <input class="form-check-input" name="question[0][is_required]" type="checkbox" value="1" id="flexCheckDefault">
...
<!-- Modal -->
<div class="modal fade inpfieldsmodalmenu" id="commonModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="editchoicebox__rgth">
                                 <button type="button" class="editchoices_button_edit">
                                    <svg width="20" height="20" viewBox="0 0 14 14" focusable="false">
                                       <path d="M2.313 9.734v1.954h1.953l5.76-5.761-1.953-1.953-5.76 5.76zm9.223-5.318a.519.519 0 0 0 0-.734l-1.218-1.219a.519.519 0 0 0-.735 0l-.953.953 1.953 1.953.953-.953z" fill-rule="nonzero" fill="#545f70"></path>
                                    </svg>
                                 </button>
                              </div>
                           </div>
                        ...
                        <div class="menu_items__acrd">
                           <div class="type_icon__box bleuiush_bg">
                              <svg viewBox="0 0 24 24" width="15" height="15" focusable="false" data-anchor="checked-checkbox-svg">
                                 ...
                                 <path fill="#5e9cff" d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-8.29 13.29a.996.996 0 0 1-1.41 0L5.71 12.7a.996.996 0 1 1 1.41-1.41L10 14.17l6.88-6.88a.996.996 0 1 1 1.41 1.41l-7.58 7.59z">
                                 </path>
                              </svg>
                           </div>
                           <span>Checkbox</span>
