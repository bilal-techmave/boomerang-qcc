...
@section('app-title', 'Edit Supplier - Quality Commercial Cleaning')
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="myForm" action="{{ route('supplier.suppliers.update', ['supplier' => $supplier->id]) }}"
                    method="post">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" required
                                            value="{{ old('name') ?? $supplier->name }}" oninput="checkUniqueData(this,'name','{{$supplier->name}}')" id="exampleInputEmail1"
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="abn" required
                                            value="{{ old('abn') ?? $supplier->abn }}" oninput="checkUniqueData(this,'abn','{{$supplier->abn}}')" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="">
                                        @error('abn')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="alt_phone_number"
                                            value="{{ old('alt_phone_number') ?? $supplier->alt_phone_number }}"
                                            id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""
                                            onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="fax_number"
                                            value="{{ old('fax_number') ?? $supplier->fax_number }}" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="">
                                        @error('fax_number')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="unit"
                                            value="{{ old('unit') ?? $supplier->unit }}" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="">
                                        @error('unit')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="zipcode" required
                                            value="{{ old('zipcode') ?? $supplier->zipcode }}" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="">
                                        @error('zipcode')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="suburb" required
                                            value="{{ old('suburb') ?? $supplier->suburb }}" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="">
                                        @error('suburb')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <select data-plugin="customselect" name="city" class="form-select">
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{ $city->id }}"
                                                    {{ old('city') ?? $city->id == $supplier->city ? 'selected' : '' }}>
                                        ...
                                        <select data-plugin="customselect" name="state" class="form-select">
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id }}"
                                                    {{ $state->id == $supplier->state ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" required
                                            value="{{ old('email') ?? $supplier->email }}" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="">
                                        @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="website"
                                            value="{{ old('website') ?? $supplier->website }}" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="">
                                        @error('website')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-lg-12">
                                    <div class="add_address">
                                        <a href="#" class="theme_btn btn add_btn " data-bs-toggle="modal"
                                            data-bs-target="#financial-info">Add Financial Information</a>
                                    </div>
                                </div>
                                <div class="col-lg-12 mt-3">
                                    <table class="table table-bordered  dt-responsive nowrap w-100">
                                            ...
                                            @if ($supplierFin)
                                                @foreach ($supplierFin as $finance)
                                                    <tr id="finance{{ $finance->id }}{{ time() }}">
                                                        ...
                                                        <td> <button type="button"
                                                                onclick="deleteRecordTbl({{ $finance->id }},'SuppliersFinancial','finance{{ $finance->id }}{{ time() }}')"
                                                                class="btn btn-danger waves-effect waves-light table-btn-custom delet_btn"><i
                                                                    class="uil-trash"></i></button></td>
                                                    </tr>
                                                @endforeach
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="action_btns">
                                        ...
                                        <a href="{{ route('supplier.suppliers.index') }}" class="theme_btn btn-primary btn"><i class="uil-list-ul"></i> List</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" id="craeteContactValidateContact">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control required_fields" id="personEmail"
                                    aria-describedby="emailHelp" placeholder="">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3 mt-3 mt-sm-0">
                                ...
                                <select class="form-select required_fields js-example-basic-single"
                    ...
                    <div class="row" id="contactValidateContact">
                        <div class="col-lg-12">
                            <div class="mb-3 mt-3 mt-sm-0">
                                ...
                                <select class="form-select js-example-basic-single5 required_fields" id="user_value">
                                    <option value="0">Please select one or start typing</option>
                                    @if ($alluser)
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3 mt-3 mt-sm-0">
                                ...
                                <select class="form-select js-example-basic-single5 required_fields" id="contact_type">
                                    <option value="0">Please select one or start typing</option>
                                    <option value="manager">Manager</option>
                                    <option value="accounts">Accounts</option>
                                    <option value="supervisor">Supervisor</option>
    ...
    <div class="modal fade" id="financial-info" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="financialtValidateContact">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3 mt-3 mt-sm-0">
                                <label class="form-label">Payment Type</label>
                                <select class="form-select payment_type js-example-basic-single4 required_fields"
                                    id="payment_type">
                                    <option value="0">Please select one or start typing</option>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="chequeName">Cheque Name <span
                                                class="red">*</span></label>
                                        <input type="text" class="form-control" id="chequeName"
                                            aria-describedby="emailHelp" placeholder="">
