                                       ...
                                       <div class="col-lg-6">
                                          <div class="fieldforcheck_Box">
                                             <label class="form-label" for="textlabel">@if($value->is_required === '1')<span class="required_Field">*</span>@endif
                                                <input type="checkbox" id="myCheckbox" name="question[{{$key}}][{{$value->filed_name}}]" >{{$value->filed_name}}</label>
                                       ...
                                       <div class="col-lg-8">
                                          <div class="check_box">
                                             ...
                                             <div class="slider-container">
                                                <input type="range" id="customRange" name="question[{{$key}}][{{$value->filed_name}}]" min="0" max="100" value="50" >
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-lg-12">
                                                <div class="form-group__CSTD customselectstyle__">
                                                   ...
                                                   <select class="form-select canvas_selectoption" name="question[{{$key}}][action][priority]">
