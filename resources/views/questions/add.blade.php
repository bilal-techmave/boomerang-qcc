...
@section('app-title', 'Add Questions - Quality Commercial Cleaning')
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form action="{{ route('question.question.store') }}" method="post" id="myForm"> @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleInputEmail1"> Sites</label>
                                        <select data-plugin="customselect" id="client_site_id" name="client_site_id"
                                            class="form-select">
                                            <option value="0">All Sites</option>
                                            @isset($sites)
                                                @foreach ($sites as $site)
                                                    <option
                                                        value="{{ $site->id }}"{{ old('client_site_id' == $site->id ? 'selected' : '') }}>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" oninput="checkUniqueData(this,'question')" required name="question"></textarea>
                                        @error('question')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row" id="inputContainer">
                                        ...
                                        @else
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="inputs[]"
                                                        id="input1" value="No access to site">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="removeInput('input1')">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="inputs[]"
                                                        id="input2" value="Faulty equipment">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="removeInput('input2')">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="inputs[]"
                                                        id="input3" value="Power outage">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="removeInput('input3')">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="inputs[]"
                                                        id="input4" value="Site contact asked cleaner to leave">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="removeInput('input4')">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="inputs[]"
                                                        id="input5" value="Others">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="removeInput('input5')">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
...
@push('push_script')
    <script>
        let inputCount = {{ old('inputs') ? count(old('inputs')) : 5 }};
