...
function ($) {
   ...
   RightBar.prototype.selectOptionsFromConfig = function() {
       var self = this;
        ...
        if(therecolor){
            therecolor = JSON.parse(therecolor);
            if(config.mode != therecolor.mode){
                setCookie('theme-color',JSON.stringify(config),30);
                therecolor = config;
            }
        }else{
            setCookie('theme-color',JSON.stringify(config),30);
        ...
        if (therecolor) {
            ...
            $('input[type=checkbox][name=color-scheme-mode][value=' + therecolor.mode + ']').prop('checked', true);
            $('input[type=checkbox][name=width][value=' + therecolor.width + ']').prop('checked', true);
            $('input[type=checkbox][name=menus-position][value=' + therecolor.menuPosition + ']').prop('checked', true);

            $('input[type=checkbox][name=leftsidebar-color][value=' + therecolor.sidebar.color + ']').prop('checked', true);
            $('input[type=checkbox][name=leftsidebar-size][value=' + therecolor.sidebar.size + ']').prop('checked', true);
            $('input[type=checkbox][name=leftsidebar-user]').prop('checked', therecolor.sidebar.showuser);

            $('input[type=checkbox][name=topbar-color][value=' + therecolor.topbar.color + ']').prop('checked', true);
        }
    },
    ...
    RightBar.prototype.toggleRightSideBar = function() {
        var self = this;
        if (self.rightBarToggled) {
            // Toggle the right sidebar
            self.body.toggleClass('right-bar-enabled');
            self.selectOptionsFromConfig();
            // Set the flag to true to indicate that the right sidebar has been toggled
        }
        self.rightBarToggled = true;
    },
