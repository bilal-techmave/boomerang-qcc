...
!function($) {
    ...
    Components.prototype.initFlatpickr = function() {
        ...
        $('#basic-datepicker2').flatpickr();
        $('#basic-datepicker3').flatpickr();
        $('#basic-datepicker4').flatpickr();
        $('#basic-datepicker5').flatpickr();
        $('#basic-datepicker6').flatpickr();
        $('#basic-datepicker7').flatpickr();
        $('#basic-datepicker8').flatpickr();
