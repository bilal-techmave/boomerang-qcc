...
!function ($) {
    ...
    ApexChartPage.prototype.initCharts = function () {
        ...
        var options = {
            ...
            series: [{
                    name: "Active - 2660",
                    data: [28, 29, 33, 36, 32, 32, 33, 31, 17, 30]
                },
                {
                    name: "Active Regular- 1116",
                    data: [12, 11, 14, 18, 17, 13, 13, 18, 28, 25]
                },
                {
                    name: "Inactive  - 678",
                    data: [15, 17, 13, 10, 12, 16, 11, 20, 15, 17]
                }
            ],
            grid: {
                row: {
            ...
            xaxis: {
                categories: ['2023-06-28', '2023-07-01', '2023-07-04', '2023-07-07', '2023-07-10', '2023-07-13', '2023-07-16', '2023-07-19', '2023-07-22', '2023-07-25'],
...
var chart = new ApexCharts(
    document.querySelector("#work-order-schedule"),
    options
);

chart.render();

// work-order-schedule chart end
...
// work-order-completed chart end
var options = {
    series: [
    {
      name: 'Sales price',
...
var options = {
  ...
  xaxis: {
    categories: ['2023-07-18', '2023-07-21', '2023-07-24', '2023-07-27', '2023-07-30', '2023-08-02', '2023-07-05'],
...
var options = {
  ...
  labels: ['Purchase', 'Sales', 'Gross Margin'],
...
var options = {
  ...
  xaxis: {
    categories: ['Thelma', 'Susan', 'Matthew', 'Luan', 'Steve Jackson', 'Suzi Ribeiro', 'Sarah Caiafa', 'Steve Jackson', 'Paul'],
  },
...
var chart = new ApexCharts(
    document.querySelector("#work-order-tdt"),
    options
);

chart.render();

// work-order-tdt chart end
...
var chart = new ApexCharts(
    document.querySelector("#ticket-status-tdt"),
    options
);
...
var chart = new ApexCharts(
    document.querySelector("#ticket_person"),
    options
);
...
// dhjkkklllllllhkskadjo;laj.k;DJ
